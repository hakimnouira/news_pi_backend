# app/schemas/user.py
from pydantic import BaseModel, EmailStr, Field, AnyUrl, field_validator, ConfigDict
...
class UserRegister(BaseModel):
    ...
    password: str = Field(..., min_length=8)  # strengthened
    # Forbid extra fields like bio, avatar_url, is_active during registration
